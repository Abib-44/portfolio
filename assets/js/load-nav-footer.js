...
const currentUrl = new URL(window.location.href);
console.log(currentUrl.protocol); // "https:"
console.log(currentUrl.host);     // "example.com"
console.log(currentUrl.pathname); // "/page"
console.log(currentUrl.search);   // "?id=123"
console.log(currentUrl.hash);     // "#section2"
